...
import { getSiteContent, updateSiteContent, HighlightsContent } from "@/app/actions";
import {
    Loader2,
    ArrowLeft,
    Save,
...
export default function HighlightsEditor() {
    ...
    const loadContent = async () => {
        setLoading(true);
        const data = await getSiteContent<HighlightsContent>("highlights");
        if (data) {
            setContent({ ...defaultHighlights, ...data });
        }
        setLoading(false);
    };
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        setSaving(true);
        setSaved(false);
        const result = await updateSiteContent("highlights", content as unknown as Record<string, unknown>);
        if (result.success) {
            setSaved(true);
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-gray-500">Edit text for the Departments/Zones section</p>
                    </div>
                </div>
